...
public class EmployeesViewImpl extends ViewObjectImpl {
    ...
    /**
     * Returns the variable value for str.
     * @return variable value for str
     */
    public String getstr() {
        return (String) ensureVariableManager().getVariableValue("str");
    }

    /**
     * Sets <code>value</code> for variable str.
     * @param value value to bind as str
     */
    public void setstr(String value) {
        ensureVariableManager().setVariableValue("str", value);
    }
